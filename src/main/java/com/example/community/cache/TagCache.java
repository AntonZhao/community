...
public class TagCache {
    public static List<TagDTO> get() {
        ...
        TagDTO eat = new TagDTO();
        eat.setCategoryName("柴米油盐");
        eat.setTags(Arrays.asList("糕点","小吃"));
        tagDTOS.add(eat);
...
//        List<List<String>> collect = tagDTOS.stream().flatMap(tagDTO -> Stream.of(tagDTO.getTags())).collect(Collectors.toList());
        ...
        String invalid = Arrays.stream(tagsSplit).filter(t -> !tagList.contains(t)).collect(Collectors.joining(","));
        return invalid;
    }
}
